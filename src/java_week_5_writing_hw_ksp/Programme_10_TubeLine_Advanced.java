...
public class Programme_10_TubeLine_Advanced {
    ...
    public static void main(String[] args) {
        ...
        String station[] = ("Aldgate,Angle,Baker Street,Bank,Barbican,Bayswater,Blackfriars,Bond Street," +
                ...
                "Farringdon,Gloucester Road,Goodges Street,Great Portlan Street,Green Paqrk").split(",");
        ...
        do {
            ...
            String c = "";
            //for loop use for stations naem in zone 1
            ...
            b = JOptionPane.showInputDialog(frame, "Do you want to try again then please press Y", "Press or N",
